...
useEffect(() => {
    async function fetchData() {
      const response = await fetch(url+`historique/historiquetous/${clientID}`);
                            ...
                            return (
                              <div class="col-xl-4">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                      <label htmlFor="">prix de vente ou dernier prix en date : </label>
                                        <p>{item.rencherir}</p>
                                        <label htmlFor="">date de publication : </label>
                                        <p>{item.enchere_date}</p>
