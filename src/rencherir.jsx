...
function EnchereDetailPage() {
    ...
    const [client_id, setClient] = useState("");
      ...
      const rencherir2 = async () => {
        try {
          const response = await axios.post(url+`propos/rencherir/${client_id}/${enchereID}/${prix}`);
                        ...
                        <div class="row">
                            ...
                            <p>{enchere.duree_id_enchere} heures</p>
                             ...
                             <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <form onSubmit={rencherir2}>
                                            <label htmlFor="">client ID</label>
                                            <input type="text" name="" value={client_id} class="form-control" id="" onChange={(event) => setClient(event.target.value)} />
                                            <label htmlFor="">prix</label>
                                            <input type="text" name="" value={prix} class="form-control" id="" onChange={(event) => setPrix(event.target.value)} /><br>
                                            </br>
